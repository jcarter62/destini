...
class StoryBrain {
  ...
  void nextStory(int choiceNumber) {
    int nxt = 0;
    if ( choiceNumber == 1 ) {
      nxt = _storyData[_storyNumber].next1;
    } else if ( choiceNumber == 2 ) {
      nxt = _storyData[_storyNumber].next2;
    }
    if ( nxt == null ) {
      nxt = 0;
    }
...
//TO DO: Step 20 - Download the story plan here: https://drive.google.com/uc?export=download&id=1KU6EghkO9Hf2hRM0756xFHgNaZyGCou3
